...
body, html { margin: 0; padding: 0; height: 100%; width: 100%; font-family: 'Montserrat', sans-serif; overflow: hidden; }
...
#sanctuary-square {
  ...
  width: 90%; max-width: 420px; min-height: 580px;
  border-radius: 25px; border: 3px solid var(--brown);
...
h1 { font-family: 'Playfair Display', serif; color: var(--sage); font-size: 1.5rem; margin: 0 0 10px 0; }
h2 { font-family: 'Playfair Display', serif; color: var(--brown); font-size: 1.3rem; margin: 10px 0; }
p, div, span, strong { color: var(--charcoal); }

.grid-container {
  display: grid; grid-template-columns: 1fr 1fr; gap: 10px;
  margin: 15px 0; max-height: 230px; overflow-y: auto; width: 100%;
}

.card {
  background: white; border: 1px solid #ccc; border-radius: 12px;
  padding: 10px; font-size: 0.7rem; text-align: left; cursor: pointer;
}

.card.selected { background-color: var(--sage) !important; color: white !important; }
.card.selected strong, .card.selected span { color: white !important; }

.instruction-text {
  font-size: 0.75rem; line-height: 1.5; background: rgba(255,255,255,0.5);
...
.custom-input { width: 45px; padding: 6px; border: 1px solid var(--brown); border-radius: 5px; text-align: center; }

button {
  background: var(--brown); color: white; border: none;
  padding: 12px 20px; border-radius: 30px; cursor: pointer; font-size: 0.85rem;
}

/* New Secondary Button Style (for Restart/Change Focus) */
.secondary-btn {
...
#timer-display { font-size: 3rem; color: var(--brown); margin: 10px 0; }
...
.mute-btn { background: none; border: 1px solid var(--brown); color: var(--brown); padding: 4px 8px; font-size: 0.6rem; border-radius: 15px; }
